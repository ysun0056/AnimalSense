<?php
/**
Template Name: Index Testing page
...
.searchable ul li.selected {
  ...
  align-items: center;
	...
	<td class = "searchBar" width = "50%"> 
    	...
    	<input id="seek" name="animalSearch" type="text" placeholder="Search Animals" onkeyup="function()" >
...
<?php
 ...
 $("animalSearch").on("keyup",function()
 {
  var value = $(this).val();

  $("#trr").each(function(result)
  {
   if (result !==0) 
   {
    var id=$(this).find("#tdd").text();
