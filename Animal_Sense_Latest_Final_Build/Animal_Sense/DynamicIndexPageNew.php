...
const myInput = document.getElementById('seek');
...
$("#seek").on("keyup",function(){
    ...
    /*cellArr.forEach(c => {
        ...
        var cellValue=c.innerText.trim().toLowerCase();
        console.log("cell value"+c.innerText.trim().toLowerCase());
        if (cellValue.search(searchValue) > -1) {
            console.log("Comparision successful");
            c.style.display = 'inline-block';//'table-cell';
        }
    })*/
 });
...
/*window.onbeforeunload = function() {
    localStorage.setItem("seek", $('#seek').val());
         		var stateElement = document.getElementById("state");
        var stateName= stateElement.options[stateElement.selectedIndex].text;
     		var classElement = document.getElementById("animalClass");
        var className= classElement.options[classElement.selectedIndex].text;
...
window.onload = function() {
    ...
    appendDataToSelect(stateName, rel);
        ...
        /*var seek = localStorage.getItem("seek");
    if (seek !== null) $('#seek').val(seek);
    if (localStorage.getItem('state') === null) { 
                localStorage.setItem('state', "All State");
                //document.write("All State");
        ...
        if (localStorage.getItem('class') === null) { 
                localStorage.setItem('class', "All Class");
                //document.write("All State");
        $('#animalClass').value("All Class");
            }
            else {
                $('#animalClass').value(localStorage.getItem('class'));
            }*/
