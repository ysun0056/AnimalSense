...
<div class = "cards">
		...
		<div class="card__info">
    		...
    		<button type="submit">Learn More</button>
                ...
                <button onclick=" window.open('https://wildlifewarriors.org.au/support/australia','_blank')">Learn More</button>
			</div>
		</div>
		</div>
		...
		<div>
            ...
            <button onclick=" window.open('https://donate.wwf.org.au/#gs.5wh7d3','_blank')">Learn More</button>
		...
		<div class="card__info">
    		...
    		<button type="submit">Learn More</button>
                ...
                <button onclick=" window.open('https://www.australiananimalrescue.org.au/donate.html','_blank')">Learn More</button>
			</div>
		</div>
		</div>
		...
		<div class="card__info">
    		...
    		<button type="submit">Learn More</button>
                ...
                <button onclick=" window.open('https://www.wildlifevictoria.org.au/donate/donate-to-wildlife-victoria','_blank')">Learn More</button>
			</div>
		</div>
		</div>
		...
		<div class="card__info">
    		...
    		<button type="submit">Learn More</button>
                ...
                <button onclick=" window.open('https://donate.zoo.org.au/donation','_blank')">Learn More</button>
			</div>
		...
		<div class="card__info">
    		...
    		<button type="submit">Learn More</button>
                ...
                <button onclick=" window.open('https://www.warriors4wildlife.org/donate','_blank')">Learn More</button>
			</div>
		...
		<div class="card__info">
    		...
    		<button type="submit">Learn More</button>
                ...
                <button onclick=" window.open('https://donations.wires.org.au/','_blank')">Learn More</button>
			</div>
		...
		<div class="card__info">
    		...
    		<button type="submit">Learn More</button>
                ...
                <button onclick=" window.open('https://kanyanawildlife.org.au/help-us-make-a-difference/','_blank')">Learn More</button>
			</div>
		...
		<div>
    		...
    		<button type="submit">Learn More</button>
                ...
                <button onclick=" window.open('https://action.hsi.org.au/page/34353/donate/1','_blank')">Learn More</button>
			</div>
		</div>
		</div>
		</div>
