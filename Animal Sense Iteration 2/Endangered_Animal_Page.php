...
.searchable ul li.selected {
	...
	<td width = "25%"><center>
		<button id="cancel" class="button">Cancel</button></center>
	</td>
	</tr>
	</table>
		<br>
    ...
    <!--Class-->
  	...
  	<option value="All Class" <?php echo (isset($_POST['animalClass']) && $_POST['animalClass'] == 'All Class') ? 'selected="selected"' : ''; ?>>All Class</option> 
  	<option value="Mammalia" <?php echo (isset($_POST['animalClass']) && $_POST['animalClass'] == 'Mammalia') ? 'selected="selected"' : ''; ?>>Mammalia</option> 
  	<option value="Reptilia" <?php echo (isset($_POST['animalClass']) && $_POST['animalClass'] == 'Reptilia') ? 'selected="selected"' : ''; ?>>Reptilia</option> 
  	<option value="Amphibia" <?php echo (isset($_POST['animalClass']) && $_POST['animalClass'] == 'Amphibia') ? 'selected="selected"' : ''; ?>>Amphibia</option> 
  	<option value="Aves" <?php echo (isset($_POST['animalClass']) && $_POST['animalClass'] == 'Aves') ? 'selected="selected"' : ''; ?>>Aves</option> 
  	<option value="Insecta" <?php echo (isset($_POST['animalClass']) && $_POST['animalClass'] == 'Insecta') ? 'selected="selected"' : ''; ?>>Insecta</option> 
  	<option value="Malacostraca" <?php echo (isset($_POST['animalClass']) && $_POST['animalClass'] == 'Malacostraca') ? 'selected="selected"' : ''; ?>>Malacostraca</option> 
  	<option value="Gastropoda" <?php echo (isset($_POST['animalClass']) && $_POST['animalClass'] == 'Gastropoda') ? 'selected="selected"' : ''; ?>>Gastropoda</option> 
  	<option value="Chondrichthyes" <?php echo (isset($_POST['animalClass']) && $_POST['animalClass'] == 'Chondrichthyes') ? 'selected="selected"' : ''; ?>>Chondrichthyes</option>
  	<option value="Actinopterygii" <?php echo (isset($_POST['animalClass']) && $_POST['animalClass'] == 'Actinopterygii') ? 'selected="selected"' : ''; ?>>Actinopterygii</option>
    </select>
...
<!--Create table to show the query result-->		
<table class = "tb">
<?php
 $i=0;
    if($total_rows == 0)
    {
        alert("No endangered animal found of class "+$class+" in state "+state);
    }
 foreach ( $result as $print ) {
  ...
  ?>  
	...
	<!--JavaScript Function-->	 
	<script> 
	function filterFunction(that, event) {  //filter search result
	...
	function onSelect(val) {  //Perform search or cancel functions
  	alert(val)
	}
	...
	$(document).ready(function(){
  			 $("#cancel").click(function(){
   			    window.location.href='http://www.animalsense.tk/endangered-animal/';
  					});
  				});
		
	$(document).ready(function(){
  			 $("#searching").click(function(){
   			    window.location.href='http://www.animalsense.tk/endangered-animal/?ID='+$("#seek").val().trim();
  					});
  				});
